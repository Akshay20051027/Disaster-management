...
const AdminDashboard = () => {
  ...
  const handleSchoolRegister = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:8000/api/auth/school/register",
        payload,
        config
      );
  ...
  const handleAdminPasswordUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(
        "http://localhost:8000/api/auth/admin/update-password",
        adminPassword,
        config
      );
      alert(res.data.message);
  ...
  const handleSchoolPasswordUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(
        "http://localhost:8000/api/auth/school/update-password",
        schoolPassword,
        config
      );
      alert(res.data.message);
  ...
  const handleDeleteAdmin = async () => {
    try {
      const res = await axios.delete("http://localhost:8000/api/auth/admin/delete", {
  ...
  const handleDeleteSchool = async () => {
    try {
      const res = await axios.delete("http://localhost:8000/api/auth/school/delete", {
        headers: config.headers,
